...
import net.abdymazhit.dangerbot.customs.LiveGame;
    ...
    public List<LiveGame> getLiveGames() {
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                String firstTeamCaptainName = DangerBot.getInstance().database.getUserName(firstTeamCaptainId);
                String secondTeamCaptainName = DangerBot.getInstance().database.getUserName(secondTeamCaptainId);
                String assistantName = DangerBot.getInstance().database.getUserName(assistantId);
