...
public class StreamAddCommandListener extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if(DangerBot.getInstance().streamsChannel.channel.equals(messageChannel)) {
            ...
            int youtuberId = DangerBot.getInstance().database.getUserId(youtuber.getId());
            if(youtuberId < 0) {
            ...
            if(contentRaw.startsWith("!stream add")) {
                ...
                DangerBot.getInstance().liveStreamsManager.addLiveStream(streamLink);
