        ...
        try {
            ...
            if(leaderResultSet.next()) {
                ...
                if(leaderDiscordId != null) {
                    DangerBot.getInstance().guild.removeRoleFromMember(leaderDiscordId, UserRole.LEADER.getRole()).queue();
                }
            }
            ...
            while(selectMemberResultSet.next()) {
                ...
                if(memberDiscordId != null) {
                    DangerBot.getInstance().guild.removeRoleFromMember(memberDiscordId, UserRole.MEMBER.getRole()).queue();
                }
            }
