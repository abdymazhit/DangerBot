...
import net.abdymazhit.mthd.customs.LiveStream;
...
public class ActiveBroadcastsChannel extends Channel {
    ...
    public ActiveBroadcastsChannel() {
        ...
        List<Category> categories = MTHD.getInstance().guild.getCategoriesByName("Danger Zone", true);
    ...
    public List<LiveStream> getLiveStreams() {
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                MTHD.getInstance().liveStreamsManager.addLiveStream(link);
            }
